 ...
 * 
 */
@WebServiceClient(name = "HelloServiceService", targetNamespace = "http://ws.java.main/", wsdlLocation = "http://10.108.166.14:8888/helloService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName HELLOSERVICESERVICE_QNAME = new QName("http://ws.java.main/", "HelloServiceService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://10.108.166.14:8888/helloService?wsdl");
    ...
    public HelloService getHelloServicePort() {
        return super.getPort(new QName("http://ws.java.main/", "HelloServicePort"), HelloService.class);
    }
    ...
    public HelloService getHelloServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://ws.java.main/", "HelloServicePort"), HelloService.class, features);
    }
